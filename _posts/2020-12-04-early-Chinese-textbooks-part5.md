...
This textbook (henceforth *Chinesische*) was written by the German general linguist and sinologist [Hans Georg Conon von der Gabelentz](https://en.wikipedia.org/wiki/Georg_von_der_Gabelentz) (1840–1893) and published in 1881, which makes it the youngest among the four textbooks in this blogpost. Its Chinese title is 漢文經緯 *Han4wen2 Jing1wei3* 'lit. longitude and latitude of the Chinese written language', which in my opinion is the most grammatical-sounding among all four Chinese titles below:
...
Titles 1–3 don't really make sense to an ordinary Chinese speaker's ears. They are understandable with some guesswork (and some peeking at the English titles), but one can easily tell that the authors aren't native speaker. Title 4, on the other hand, sounds totally natural and appealing, as if it had been given by an erudite traditional Chinese scholar.

Since von der Gabelentz was a linguist, his textbook is quite linguistically oriented and so also more accurate in terms of grammatical concepts. Indeed, after reading through the book I feel that modern linguists can directly take the descriptions in it as the basis for more advanced theoretical analyses.

This textbook is freely available online ([link](https://books.google.com.hk/books?id=liwwAAAAYAAJ&printsec=frontcover&source=gbs_ge_summary_r&redir_esc=y#v=onepage&q&f=false)). Also, due to its highly technical nature, the author had subsequently published a beginner's version entitled *Anfangsgründe der Chinesischen Grammatik* 'Rudiments of the Chinese Grammar' (1883), henceforth *Anfangsgründe*, which is freely available too ([link](https://books.google.com.hk/books?id=liwwAAAAYAAJ&printsec=frontcover&source=gbs_ge_summary_r&redir_esc=y#v=onepage&q&f=false)).

My review here is mainly based on the unabridged version, though I'll include stuff from the beginner's version from time to time as well because it contains a part on colloquial Chinese in addition to the Classical Chinese parts inherited from the unabridged version. This makes von der Gabelentz's book the only one that teaches both written and spoken Chinese. 👏
...
The general introduction part begins with some general information of the Chinese language, such as its history, its dialects, and its influence in East Asia. After that, the author uses two chapters to teach pronunciation and characters. Both the second and the third part are on Classical Chinese grammar, but the author had separated the grammatical stuff in two parts, respectively calling them the "analytic" and the "synthetic" system. Under the two parts we find the following major topics:
- "Analytic" part:
...
Despite my low rating for the overall structure of von der Gabelentz's (unabridged) textbook, when it comes the detailed content of each individual chapter, I actually find the author's descriptions and notes surprisingly informative. I give the pronunciation part of von der Gabelentz's textbook five stars based on the following three reasons.

First and foremost, an absolutely unique thing that von der Gabelentz did in his textbook was that he clearly and precisely marked all the [entering-tone](https://en.wikipedia.org/wiki/Checked_tone) characters in his romanization system, even though the entering tone had already vanished from Beijing Mandarin at his time. As for the motivation, he wrote:
...
And on the same page he also wrote:
...
Each of these aspects are accompanied by ample illustration, and again the author pays a lot of attention to the details. For instance, in the section about the traditional classification of characters, he not only lists the names of the classes but also cites the number of characters for each class included in a particular dictionary, so that readers can easily get an impression of the relative proportions of the six classes.
...
Von der Gabelentz doesn't illustrate the character-deleting circle, so I've found an example from an alternative source.
...
The only piece of information that I've found in Marshman's book but haven't in von der Gabelentz's is that on recursive character formation, though I notice something vaguely relevant:
...
I've also noticed a wrong character transcription in the section on character history 😂, where the ancient script name 籕 *zhou4* (in pinyin) or *čeú* (in the author's romanization system) is wrongly transcribed as *lieú*. Besides, the precise character should actually be [籀](https://zh.wikipedia.org/zh-tw/籀文), while 籕 is merely a vulgar allograph of it that had resulted from historical miscopying (à la [*Hanyu Da Cidian*](https://en.wikipedia.org/wiki/Hanyu_Da_Cidian)).
...
[Link to Part 6]({{ site.baseurl }}{% post_url 2020-12-04-early-Chinese-textbooks-part6 %})
