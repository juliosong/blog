...
Branan observes that in Japanese and Tagalog, two other typical scrambling languages, the scrambling operation creates different [scope](http://www.glottopedia.org/index.php/Scope) effects, which partly contradict the Lexical Correspondence Axiom (LCA) put forward in Kayne's (1994) seminal monograph [*The Antisymmetry of Syntax*](https://mitpress.mit.edu/books/antisymmetry-syntax). Thus, it is okay to put an object in front of a subject that contains a possessive pronoun coreferential with the object in Japanese, as in (3), but not okay to do so in Tagalog, as in (4). Both examples are taken from Branan's slides, with slight adjustments.
