...
This time I tried explaining from a less scholarly angle, "Well, it really studies everything about language, such as speech sounds, words, grammar, and meaning." I paused a bit, "But the biggest question is why a human baby can master a language within such a short time whereas, say, a kitty or a puppy can't."
...
"In the genes according to the theory we are pursuing," I answered, "though perhaps only indirectly." I quickly added, for fear of disseminating the false message that there's a particular "linguistic gene." Even though [FOXP2](https://en.wikipedia.org/wiki/FOXP2) had been discussed for a while (see this recent [article](http://www.ai.mit.edu/projects/dm/foxp2.pdf) for an up-to-date review), it [was never an unchallenged discovery](https://www.sciencedaily.com/releases/2018/08/180802141733.htm); even less clear was its correlation with the universal grammar theory.
...
I followed the "language instinct" route again, hoping to get across the idea that human beings are born with language learning talent. But my aunt wanted to know more---she wanted to know **what exactly were in the so-called universal grammar**, the concept I had timely thrown to her.
...
This was a question as challenging as that posed by my high school teacher, since both my teacher and my aunt have studied the grammar of (Old and Modern) Chinese in depth. I didn't have a ready answer and so just acknowledged that what I had hold her were indeed only the basics.
